...
from api.restful.resources.projects_api import ProjectsApi, ProjectResourceApi
...
api_v1.add_resource(ProjectResourceApi, '/projects/<project_id>/resource', '/projects/<project_id>/resource/<resource_id>')
